...
export function SignIn() {
  ...
  return (
    <div className="min-h-screen flex flex-col md:flex-row">
      <div className="w-full md:w-1/2 bg-gradient-to-b from-blue-500 to-purple-600 animate-gradient-y flex items-end justify-center">
        <div className="p-4">
      ...
      <div className="w-full md:w-1/2 flex flex-col justify-center items-center bg-white p-8">
        <div className="max-w-sm w-full space-y-6">
          <h2 className="text-3xl font-bold text-center text-gray-900">Sign In to <span className="bg-gradient-to-r from-blue-500 to-purple-600 text-transparent bg-clip-text animate-pulse">{PROJECT_NAME}</span></h2>
          ...
          <div className="text-center">
            <Link to="/signup" className="text-indigo-600 hover:text-indigo-500">Create a new account</Link>
          </div>
        </div>
      </div>
      <style jsx>{`
